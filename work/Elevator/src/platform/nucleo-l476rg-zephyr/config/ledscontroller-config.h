#ifndef BOARD_LEDSCONTROLLER_CONFIG_H
#define BOARD_LEDSCONTROLLER_CONFIG_H

/**
 * Do NOT edit this file!
 *
 * This is the default LedsController config file.
...
#define LEDSCONTROLLER_TRACE_ENABLE      0

#endif // BOARD_LEDSCONTROLLER_CONFIG_H
